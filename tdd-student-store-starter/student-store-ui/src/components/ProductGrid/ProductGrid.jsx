...
export default function ProductGrid(props) {
  ...
  return ( 
    <div className="product-grid">
      ...
      { ourProducts?.filter(product=>product.name.toLowerCase().includes(query)).filter(product=>product.category.includes(category)).length == 0 ? <h2> Nothing Found</h2> : null}
